...
public class Brontosaurus extends AbstractionLayerAI {
    ...
    public Brontosaurus(UnitTypeTable a_utt) {
        this(a_utt, new FloodFillPathFinding());
    }

    public Brontosaurus(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new Brontosaurus(utt, pf);
    }
    ...
    public PlayerAction getSimulatedAction(int player, GameState gs) {
