...
public class SampleCodeTest extends AbstractionLayerAI {
    ...
    public SampleCodeTest(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public SampleCodeTest(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new SampleCodeTest(utt, pf);
    }
...
//        System.out.println("HeavyRushAI for player " + player + " (cycle " + gs.getTime() + ")");
    ...
    public void barracksBehavior(Unit u, Player p, PhysicalGameState pgs) {
        if (p.getResources() >= lightType.cost && lightUnits <= heavyUnits) {
            train(u, lightType);
            lightUnits ++;
        }
